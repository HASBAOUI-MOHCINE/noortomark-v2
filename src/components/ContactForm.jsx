  ...
  return (
    <section id="contact" className="py-20 md:py-24 bg-slate-800">
      <div className="container mx-auto px-6 lg:px-8 max-w-4xl">
        ...
        <form onSubmit={handleSubmit} className="bg-black/50 backdrop-blur-sm border border-gold-400/30 rounded-2xl p-8 md:p-10">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {/* Service Selection */}
            <div className="md:col-span-2">
              <label htmlFor="service" className="block text-gold-400 font-semibold mb-3 text-lg sm:text-xl">
                {t('choose-service')}
              </label>
              <select
                id="service"
            ...
            {/* Name */}
            <div>
              <label htmlFor="name" className="block text-gold-400 font-semibold mb-3 text-lg sm:text-xl">
                {t('full-name')}
              </label>
              <input
                type="text"
            ...
            {/* Email */}
            <div>
              <label htmlFor="email" className="block text-gold-400 font-semibold mb-3 text-lg sm:text-xl">
                {t('email-address')}
              </label>
              <input
                type="email"
            ...
            {/* Phone */}
            <div className="md:col-span-2">
              <label htmlFor="phone" className="block text-gold-400 font-semibold mb-3 text-lg sm:text-xl">
                {t('phone-number')}
              </label>
              <input
                type="tel"
            ...
            {/* Message */}
            <div className="md:col-span-2">
              <label htmlFor="message" className="block text-gold-400 font-semibold mb-3 text-lg sm:text-xl">
          ...
          <div className="mt-8 text-center">
            <button
              ...
              className="btn-gold disabled:opacity-50 disabled:cursor-not-allowed w-full sm:w-auto min-w-[200px] px-10 py-5 text-lg sm:text-xl"
            >
              {isSubmitting ? (
