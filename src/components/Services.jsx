      ...
      <div className="container mx-auto px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 lg:gap-8">
          {services.map((service, index) => (
            <div
              key={service.title}
              className="group relative bg-gradient-to-br from-stone-800/50 to-stone-900/50 backdrop-blur-lg rounded-3xl p-6 lg:p-8 border border-stone-700/50 hover:border-amber-400/30 transition-all duration-500 hover:scale-105 hover:shadow-2xl hover:shadow-amber-500/10"
              style={{ 
            ...
            >
              ...
              <div className="relative">
                ...
                {/* Footer with CTA */}
                <div className="flex items-center justify-between pt-6 border-t border-stone-700/50 group-hover:border-amber-400/30 transition-colors duration-300">
        ...
        <div className="text-center mt-16 lg:mt-20">
          <div className="bg-gradient-to-br from-stone-800/50 to-stone-900/50 backdrop-blur-lg rounded-3xl p-8 lg:p-12 border border-stone-700/50 max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a 
                href="#contact" 
                className="inline-flex items-center gap-3 bg-gradient-to-r from-amber-400 to-amber-600 text-stone-900 font-semibold py-4 px-8 rounded-lg transition-all duration-300 hover:shadow-2xl hover:shadow-amber-500/25 hover:scale-105"
              >
              ...
              <a 
                href="#about" 
                className="inline-flex items-center gap-3 border-2 border-stone-600 text-white font-semibold py-4 px-8 rounded-lg backdrop-blur-sm transition-all duration-300 hover:border-amber-400 hover:bg-amber-400/5 hover:scale-105"
              >
